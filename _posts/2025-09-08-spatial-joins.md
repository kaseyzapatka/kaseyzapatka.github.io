...
If you want to run the code locally, you can download the original Jupyter notebook:  [📥 Download spatial joins script](https://github.com/kaseyzapatka/kaseyzapatka.github.io/tree/main/assets/jupyter/spatial_joins.ipynb)
